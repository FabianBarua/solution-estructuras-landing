    ...
    <Card className="w-full max-w-sm">
      ...
      <CardContent className="grid gap-4">
        <div className="grid gap-2">
          ...
          <Input id="username" autoComplete="off" name="username" type="username" placeholder="Ingrese un usuario" required />
        </div>
        <div className="grid gap-2">
          <Label htmlFor="password">Contraseña</Label>
          <Input id="password" name="password" placeholder="Ingrese la contraseña" type="password" required />
        </div>
      </CardContent>
      <CardFooter>
