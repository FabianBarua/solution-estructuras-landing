...
export const DashboardLayout = ({url, children }) => {
    ...
    const selectedClass = "flex items-center gap-3 rounded-lg bg-muted px-3 py-2 text-primary transition-all hover:text-primary"
    const unselectedClass = "flex items-center gap-3 rounded-lg px-3 py-2 text-muted-foreground transition-all hover:text-primary"
            ...
            <div className="hidden border-r bg-muted/40 md:block">
              <div className="flex h-full max-h-screen flex-col gap-2">
                ...
                <div className="grid items-start px-2 pb-3 text-sm  lg:px-4">
                  <Button onClick={ closeSession } size="sm" variant="secondary" className=" mt-auto  w-full">
                      Cerrar sesion
                  </Button>
                </div>
              </div>
